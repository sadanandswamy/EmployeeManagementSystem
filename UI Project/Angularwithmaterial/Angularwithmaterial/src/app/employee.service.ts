...
export class EmployeeServiece {
  ...
  getEmployees(): Observable<Employee[]> {
    ...
    return this._http.get<Employee[]>(this.serviceurl, {headers:this.header});
  ...
  getEmployee(id: number): Observable<Employee> {
    ...
    return this._http.get<Employee>(url, {headers:this.header});

  }

  InsertEmployee(employee: Employee): Observable<Employee> {
    return this._http
      .post<Employee>(this.serviceurl, (employee), {headers:this.header})
      ;
  ...
  UpdateEmployee(employee: Employee): Observable<Employee> {
    ...
    return this._http.put<Employee>(url, (employee), {headers:this.header})
  }
...
console.log(localStorage.getItem('currentUserToken'));
    return this._http
      .post<ILogin>(this.registerurl, JSON.stringify({ UserName, password }), {headers:this.header});
